...
public class UIDocumento extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        chActivar.setFont(new java.awt.Font("Roboto Medium", 0, 12)); // NOI18N
        ...
        btnMenu.setPreferredSize(new java.awt.Dimension(46, 70));
        ...
        jTBuscar.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        jTBuscar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        jTBuscar.setPreferredSize(new java.awt.Dimension(80, 25));

        Search.setBackground(new java.awt.Color(186, 186, 186));
        Search.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        Search.setIcon(new javax.swing.ImageIcon(getClass().getResource("/scik/recursos/search.png"))); // NOI18N
        Search.setBorder(null);
        Search.setPreferredSize(new java.awt.Dimension(28, 28));
