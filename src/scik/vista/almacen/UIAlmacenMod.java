...
public class UIAlmacenMod extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        txtAlmUbi.setPreferredSize(new java.awt.Dimension(0, 25));
        ...
        txtAlmNom.setPreferredSize(new java.awt.Dimension(0, 25));

        txtAlmCod.setEditable(false);
        txtAlmCod.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        txtAlmCod.setPreferredSize(new java.awt.Dimension(0, 25));
